...
inversion described in `docs/milestone-history.md` (M17): the *worker* is allowed to read
...
versions used in the PR that lands this runbook (see `docs/milestone-history.md`, M17) — this
