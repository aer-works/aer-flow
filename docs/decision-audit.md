...
| 0049 | unaffected | The wake-loop/orchestrator contract. Rests on post-audit measurements named in its own Rests on table (resume + MCP on both vendors, the permission-machinery asymmetry, `RoomWakeBridge`'s code read 2026-08-03) — none of them #527-audit vendor claims. |
