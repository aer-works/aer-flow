| | `claude` 2.1.219 (Claude Code) | `agy` 1.1.7 |
|---|---|---|
| plan usage & reset | **`/usage` — 33% used, with reset times** | not found on: --help, subcommand list, in-session slash command |
