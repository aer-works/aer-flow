...
/// output written through the <c>AER_OUTPUT_DIR</c> placeholder <c>CoreDispatcher</c> expands, the base
...
public class CaptureWorkerAdapterTests
{
    ...
    public void Resolve_diffs_the_injected_base_ref_into_the_capture_output_file()
    {
        ...
        // Output rides an --output= arg built from the AER_OUTPUT_DIR placeholder and the fixed artifact
