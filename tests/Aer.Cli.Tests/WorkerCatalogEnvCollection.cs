...
/// process-global env vars (<c>AER_WORKER_ROLES_PATH</c>, <c>AER_WORKER_TIERS_PATH</c>,
/// <c>AER_WORKFLOW_TEMPLATES_PATH</c>). xUnit runs classes in parallel, and one of them
...
/// <c>Aer.Adapters.Tests</c> analogue is <c>WorkerRoleCatalogCollection</c>, created for the same reason.
/// </summary>
/// <remarks>
