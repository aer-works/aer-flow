...
public sealed class RoomRetentionSweep : BackgroundService
{
    ...
    public const string PruneEnabledEnvironmentVariable = "AER_RETENTION_PRUNE_ENABLED";
    public const string PruneGraceSecondsEnvironmentVariable = "AER_RETENTION_PRUNE_GRACE_SECONDS";
