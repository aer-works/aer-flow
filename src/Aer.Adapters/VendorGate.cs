    ...
    IReadOnlyDictionary<string, string> Environment)
{
    ...
    /// </remarks>
    public static VendorGate? For(string vendor, PermissionGrant? grant) => vendor switch
    {
        "claude" => ClaudeWorkerAdapter.BuildGate(grant),
        "gemini" => GeminiWorkerAdapter.BuildGate(grant),
        _ => null,
    };
}
