...
/// <summary>
/// Engine bookkeeping counters for machine turns and failures under <c>{room}/.aer/turn-usage.json</c> (#778).
/// <para>
/// <b>Location rationale:</b> Lives under <c>{room}/.aer/</c> because usage tracking is internal engine
