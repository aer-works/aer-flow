...
/// <c>head_before</c>). Kept in the CLI, not <c>Aer.Flow</c>: the engine stays git-agnostic, and the
/// only other place that knows git is <c>Aer.Adapters.CaptureWorkerAdapter</c> (Adapter Isolation).
/// </summary>
