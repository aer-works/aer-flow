...
Write your report to janitor.md in AER_OUTPUT_DIR: checkers run, what each said before and after, files touched, commit hash or "nothing to do", and any `[NOT DONE]` items.
